        ...
        <section className="py-20 bg-slate-50">
            <div className="max-w-7xl mx-auto px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-center text-slate-900 mb-16">
                    Why Your Cold Outreach is <span className="text-red-600">Failing</span>
                </h2>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {problems.map((prob, idx) => (
                        <div key={idx} className="bg-white border border-slate-200 p-8 rounded-2xl hover:border-red-200 hover:shadow-sm transition-all">
                            <div className="bg-slate-50 w-16 h-16 rounded-full flex items-center justify-center mb-6 border border-slate-100">
                                {prob.icon}
                            </div>
